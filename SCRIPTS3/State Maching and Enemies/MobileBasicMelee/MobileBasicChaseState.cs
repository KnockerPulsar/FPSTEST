...
public class MobileBasicMeleeChaseState : IState
{
    ...
    public MobileBasicMeleeChaseState(GameObject inputEntity, float inputMS, float inputSD, float inputJCI, float inputDashChance, float inputDashCooldown, float inputDashLength, Rigidbody inputRB, GameObject inputCheckObj)
    {
        entity = inputEntity;
