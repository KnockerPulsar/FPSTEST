...
public class ChargeRotation : IState
{
    ...
    public ChargeRotation(GameObject inputEntity, float inputRotSpeed, float inputChargeAngle, Rigidbody inputRB)
    {
        entity = inputEntity;
    ...
    public void Tick()
    {
        ...
        hPlayerEnemyVec = PlayerVariables.player.transform.position - entity.transform.position;
        hPlayerEnemyVec.y = 0;
