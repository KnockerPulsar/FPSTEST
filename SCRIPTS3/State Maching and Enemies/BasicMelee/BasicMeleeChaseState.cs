...
public class BasicMeleeChaseState : IState
{
    // Old variables used for navigation
    ...
    public BasicMeleeChaseState(GameObject inputEntity, NavMeshAgent agent, Rigidbody inputRB)
    {
        navMeshAgent = agent;
    ...
    public void Tick()
    {
        ...
        navMeshAgent.destination = PlayerVariables.playerPos;
    }
