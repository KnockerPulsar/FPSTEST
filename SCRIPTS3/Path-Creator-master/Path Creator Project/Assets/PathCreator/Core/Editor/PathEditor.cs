...
namespace PathCreationEditor {
    ...
    public class PathEditor : Editor {
        ...
        public override void OnInspectorGUI () {
            ...
            // Draw inspector for pickedUp tab
        ...
        void DrawHandle (int i) {
            ...
            bool isInterpickedUp = isAnchorPoint || bezierPath.ControlPointMode != BezierPath.ControlMode.Automatic;
            ...
            handlePosition = PathHandle.DrawHandle (handlePosition, bezierPath.Space, isInterpickedUp, handleSize, cap, handleColours, out handleInputType, i);
