...
public class MouseLookScript : MonoBehaviour
{
    ...
    void Start()
    {
        targetOrientation = pVars.player.transform.rotation;
    ...
    private void MouseLook()
    {
        ...
        //Modified to work with a parent object + a child pVars.playerCamera.
        ...
        pVars.playerCam.transform.localRotation = Quaternion.AngleAxis(mouseAbsolute.y, Vector3.right);
