...
public class BasicRangedPosition : StateInterface
{
    ...
    public BasicRangedPosition(GameObject inputEntity, float inputMS, float inputAR, float inputBFR, Rigidbody inputRB, PlayerVariables inputPVars)
    {
        entity = inputEntity;
    ...
    public void Tick()
    {
        ...
        hPlayerPos = pVars.player.transform.position;
